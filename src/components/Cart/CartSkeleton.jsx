...
const CartSkeleton = () => {
    return (
        <div className="min-h-screen bg-gray-50 pt-32 pb-20 px-4 sm:px-6 lg:px-8 animate-pulse">
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="flex-grow">
                        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                            {/* Header Skeleton */}
                            <div className="hidden md:grid grid-cols-12 gap-4 p-6 bg-gray-50">
                                <div className="col-span-6 h-4 bg-gray-200 rounded w-20"></div>
                                <div className="col-span-3 h-4 bg-gray-200 rounded w-16 mx-auto"></div>
                                <div className="col-span-3 h-4 bg-gray-200 rounded w-16 ml-auto"></div>
                            </div>

                            {/* Row Skeletons */}
                            {[1, 2, 3].map((i) => (
                                <div key={i} className="p-6 grid grid-cols-1 md:grid-cols-12 gap-6 items-center border-t border-gray-100">
                    ...
                    <div className="lg:w-96 flex-shrink-0">
                        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-100">
                            <div className="h-6 bg-gray-200 rounded w-40 mb-6 pb-4 border-b border-gray-200"></div>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/50 backdrop-blur-sm">
                <div className="bg-white px-6 py-4 rounded-full shadow-2xl flex items-center space-x-3">
